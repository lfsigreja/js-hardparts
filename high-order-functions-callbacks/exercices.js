...
// console.log(reduce([4, 1, 3], function(a, b) { return a + b; }, 1))


// Challenge 7
function intersection(arrays) {
  return reduce(arrays, function(array, accumulator) {
    const commomElements = []
    forEach(accumulator, function(element) {
      if (array.includes(element)) {
        commomElements.push(element)
      }
    })
...
function objOfMatches(array1, array2, callback) {
  ...
  forEach(array1, function(element, index){
		if (callback(element) === array2[index]) {
      output[element] = array2[index]
    }
  })
...
// console.log(objOfMatches(['hi', 'a', 'bye', 'later', 'hello'], ['HI', 'Howdy', 'BYE', 'LATER', 'hello'], function(str) { return str.toUpperCase(); }));
...
function multiMap(arrVals, arrCallbacks) {
  ...
  forEach(arrVals, function(element) {
    output[element] = map(arrCallbacks, func => func(element))
  }) 
...
function objectFilter(obj, callback) {
  ...
  forEach(Object.keys(obj), function(element) {
...
// Paris: 'PARIS',
// };
// console.log(objectFilter(cities, function(str) { return str.toUpperCase(); })) // Should log { London: 'LONDON', Paris: 'PARIS'}
